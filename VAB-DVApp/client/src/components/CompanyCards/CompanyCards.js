...
const CompanyCards=({companydata})=>{
  ...
  const infoCards=[
    ...
    { color: '#1565c0', title: 'Something by Something', info: 'Business, Entertainment, General, Health, Science, Sports, Technology', text: 'Give me the latest Technology news' },
    { color: '#4527a0', title: 'Something by Something', info: 'Bitcoin, PlayStation 5, Smartphones, Donald Trump...', text: 'What\'s up with PlayStation 5' }
  ];
